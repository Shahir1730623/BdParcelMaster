...
class UserSheetsApi {
  ...
  static Worksheet? _userSheet, _rateSheet, _zoneSheet, _ess_fuel;
  ...
  static Future init() async {
    try {
      ...
      _ess_fuel = await _getWorkSheet(spreadsheet, title: 'ESS_FUEL');
      ...
      final firstRow4 = Ess_Fuel.getEss_Fuel();
      _ess_fuel!.values.insertRow(1, firstRow4);
    } catch (e) {
      print('Init Error: $e');
    }
  }
  ...
  static Future<Ess_dollar?> getById4(int id) async {
    if(_ess_fuel == null) return null;

    final json = await _ess_fuel!.values.map.rowByKey(id, fromColumn: 1);
    return json == null ? null : Ess_dollar.fromJson(json);
  }
