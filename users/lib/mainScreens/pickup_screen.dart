...
class _PickUpRequestState extends State<PickUpRequest> {
  ...
  Future<void> getData() async {
    ...
    final ess_fuel_dollar = await UserSheetsApi.getById4(1);
    print(ess_fuel_dollar);

    var ess = ess_fuel_dollar!.toJson()["ess"];
    print(ess);

    var fuel = ess_fuel_dollar.toJson()["fuel"];
    print(fuel);

    var dollar = ess_fuel_dollar.toJson()["dollar"];
    print(dollar);
    ...
    var value3 = value2 + (ess * weightId2);
    var value4 = value3 + value3 * fuel/100;
    var value5 = value4 * dollar;
    var value6 = value5 + value5 * 0.25;
