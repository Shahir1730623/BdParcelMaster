...
import 'package:users/mainScreens/select_nearest_active_driver_screen.dart';
...
{
  late String receiverName, receiverAddress, receiverCountry, weight, amount;
...
class _MainScreenState extends State<MainScreen> {
  ...
  String driverRideStatus = "Pickup man is coming";
  StreamSubscription<DatabaseEvent>? tripRisdeRequestInfoStreamSubscription;
  ...
  saveRideRequestInformation() {
    ...
    Map userInformationMap = {
      ...
      "receiverCountry": widget.receiverCountry,
    ...
    tripRisdeRequestInfoStreamSubscription =
              ...
              if ((eventSnap.snapshot.value as Map)["fareAmount"] != null) {
                ...
                if (response == "Cash Paid") {
                  ...
                  if ((eventSnap.snapshot.value as Map)["driverId"] != null) {
                    ...
                    tripRisdeRequestInfoStreamSubscription!.cancel();
                  }
                }
              }
            }
  ...
  updateArrivalTimeToUserPickUpLocation(driverCurrentPositionLatLng) async {
    if (requestPostionInfo == true) {
      ...
      setState(() {
        driverRideStatus = "Pickup Man is coming : " +
  ...
  searchNearestOnlineDrivers() async {
    ...
    if (onlineNearByAvailableDriversList.length == 0) {
      ...
      Fluttertoast.showToast(msg: "No online nearest Driver Available. Your request is pending.");

      Fluttertoast.showToast(msg: "Please wait we will contact you.");

      // Fluttertoast.showToast(
      //     msg: "Search again for driver after some time. Restarting app");
              ...
              child: GestureDetector(
                onTap: () {
                  if (openNavigationDrawer) {
                    ...
                    //restart refresh - minimize app automatically, in order to refresh the app
                    //SystemNavigator.pop();
    ...
    Future<void> drawPolyLineFromOriginToDestination() async
    {
      ...
      List<PointLatLng> decodedPolyLinePointsResultList = pPoints
          .decodePolyline(directionDetailsInfo.e_points!);
