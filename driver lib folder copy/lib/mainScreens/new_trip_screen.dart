...
import 'package:driver/widgets/fare_amount_collection_dialog.dart';
...
class _NewTripScreenState extends State<NewTripScreen>
{
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ElevatedButton.icon(
                              onPressed: () async {
                                await FlutterPhoneDirectCaller.callNumber(widget.userRideRequestDetails!.userPhone!);
                              },
                    ...
                    ElevatedButton.icon(
                      onPressed: () async
                      {
                        ...
                        if(rideRequestStatus == "accepted")
                        {
                          ...
                          setState(() {
                            buttonTitle = "Go to Precise Location"; //start the trip
  ...
  endTripNow() async
  {
    ...
    FirebaseDatabase.instance.ref().child("All Ride Requests")
        .child(widget.userRideRequestDetails!.rideRequestId!)
        .child("fareAmount")
        .set(widget.userRideRequestDetails!.amount);
    ...
    showDialog(
        ...
        builder: (BuildContext c)=> FareAmountCollectionDialog(
          ...
          totalFareAmount: double.parse(widget.userRideRequestDetails!.amount!),
        )
    );
    ...
    FirebaseDatabase.instance.ref()
      ...
      if(snap.snapshot.value != null){ //earnings sub child exists
        ...
        double driverTotalEarnings = double.parse(widget.userRideRequestDetails!.amount!) + oldEarnings;
        ...
        FirebaseDatabase.instance.ref()
            ...
            .child(currentFirebaseUser!.uid)
            .child("earnings")
            .set(widget.userRideRequestDetails!.amount!.toString());
      }
    });
