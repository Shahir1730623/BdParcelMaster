...
class PendingHistortyDesignUIWidget extends StatefulWidget {
  TripsHistoryModel? tripsHistoryModel;

  PendingHistortyDesignUIWidget({this.tripsHistoryModel});

  @override
  State<PendingHistortyDesignUIWidget> createState() => _PendingHistortyDesignUIWidgetState();
}

class _PendingHistortyDesignUIWidgetState extends State<PendingHistortyDesignUIWidget> {
