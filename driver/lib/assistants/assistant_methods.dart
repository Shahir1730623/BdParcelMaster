import 'package:driver/assistants/request_assistant.dart';
...
class AssistantMethods{
  ...
  static void readTripsKeysForOnlineDriver(context)
  {
        ...
        .then((snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        readPendingTripsHistoryInformation(context);
      }
    });
  ...
  static void readTripsHistoryInformation(context)
  {
    ...
    for(String eachKey in tripsAllKeys)
    {
          ...
          .then((snap)
      {
        ...
        if((snap.snapshot.value as Map)["status"] == "completed")
        {
  ...
  static void readPendingTripsHistoryInformation(context)
  {
    var tripsAllPendingKeys = Provider.of<AppInfo>(context, listen: false).historyTripsKeysList;

    for(String eachKey in tripsAllPendingKeys)
    {
      FirebaseDatabase.instance.ref()
          .child("All Ride Requests")
          .child(eachKey)
          ...
          .then((snap)
      {
        ...
        if((snap.snapshot.value as Map)["status"] == "pending")
        {
          //update-add each history to OverAllTrips History Data List
          Provider.of<AppInfo>(context, listen: false).updateOverAllPendingHistoryInformation(eachTripHistory);
        }
      });
    }
  }
