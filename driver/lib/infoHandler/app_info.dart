...
class AppInfo extends ChangeNotifier
{
  ...
  List<TripsHistoryModel> allPendingHistoryInformationList = [];
  ...
  updateOverAllPendingHistoryInformation(TripsHistoryModel eachTripHistory)
  {
    allPendingHistoryInformationList.add(eachTripHistory);
    notifyListeners();
  }
